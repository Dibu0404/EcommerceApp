package com.dibu0404.developer.ecommerceapp.Adapters;
...
import com.dibu0404.developer.ecommerceapp.DetailActivity;
import com.dibu0404.developer.ecommerceapp.Models.OrdersModel;
import com.dibu0404.developer.ecommerceapp.R;
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                new AlertDialog.Builder(context)
                        ...
                        .setMessage("You want to delete this order?")
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                DBHelper helper=new DBHelper(context);
                                if (helper.deleteOrder(model.getOrderNumber()) > 0){
                                    Toast.makeText(context, "Uff!! You Loss this Order.", Toast.LENGTH_SHORT).show();
                                }
                                else {
